...
void a3demo_loadShaders(a3_DemoState *demoState)
{
	...
	union {
	...
	} shaderList = {
		{
			...
			{ { { 0 },	"shdr-vs:pass-tex",				a3shader_vertex  ,	1,{ A3_DEMO_VS"basic-shading/passTexcoord_transform_vs4x.glsl" } } }, //DISABLE THE E HERE
			...
			{ { { 0 },	"shdr-fs:draw-tex",				a3shader_fragment,	1,{ A3_DEMO_FS"basic-shading/drawTexture_fs4x.glsl" } } }, //DISABLE THE E HERE
		}
	};
